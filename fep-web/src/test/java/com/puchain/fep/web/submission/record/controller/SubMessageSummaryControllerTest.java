...
/**
 * Message summary controller integration test.
 *
 * <p>Covers the message summary aggregation endpoint.
 * See PRD v1.3 section 5.5.5 (FR-WEB-SUB-LIST).</p>
 *
 * @author FEP Team
 * @since 1.0.0
 */
...
class SubMessageSummaryControllerTest {
    ...
    private static final String BASE_URL = "/api/v1/submission/message-summary";
    ...
    /**
     * Get message summary should return array (may be empty).
     *
     * @throws Exception on request failure
     */
    @Test
    void getMessageSummary_shouldReturnList() throws Exception {
     ...
     */
    @Test
    void getMessageSummary_noAuth_shouldReturn401() throws Exception {
        mockMvc.perform(get(BASE_URL))
