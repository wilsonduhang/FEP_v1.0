  ...
  >
    <el-form ref="formRef" :model="form" :rules="rules" label-width="120px">
      <el-form-item label="企业 ID" prop="enterpriseId">
        <el-input v-model="form.enterpriseId" placeholder="发起查询的企业 ID" />
      </el-form-item>
      <el-form-item label="查询类型" prop="queryType">
        <el-radio-group v-model="form.queryType">
          <el-radio value="REALTIME"> 实时（1001→2001） </el-radio>
          <el-radio value="BATCH"> 批量（1103→2103） </el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="被查询 USCI" prop="usci">
        <el-input v-model="form.usci" placeholder="18 位统一社会信用代码" maxlength="18" />
      </el-form-item>
      <el-form-item label="企业名称" prop="queryTargetName">
        <el-input v-model="form.queryTargetName" placeholder="可选" maxlength="200" />
      </el-form-item>
      <el-form-item v-if="form.queryType === 'BATCH'" label="批量文件路径" prop="batchFilePath">
        <el-input
