...
class QyAccQuery3005XsdValidationTest extends AbstractXsdValidationTest {
    ...
    private static final String VALID_FULL_FIELDS_XML = """
            ...
            <CFX>
              <HEAD>
                ...
                <App>FEPx</App>
                <MsgNo>3005</MsgNo>
                <MsgId>30050000000000000001</MsgId>
    ...
    private static final String VALID_OPTIONAL_OMITTED_XML = """
            ...
            <CFX>
              <HEAD>
                ...
                <App>FEPx</App>
                <MsgNo>3005</MsgNo>
                <MsgId>30050000000000000002</MsgId>
                <CorrMsgId>00000000000000000000</CorrMsgId>
                <WorkDate>20260513</WorkDate>
              </HEAD>
              <MSG>
    ...
    private static final String INVALID_MISSING_QYACCCODE_XML = """
            <?xml version="1.0" encoding="UTF-8"?>
            <CFX>
              <HEAD>
                <Version>1.0</Version>
                ...
                <App>FEPx</App>
                <MsgNo>3005</MsgNo>
                <MsgId>30050000000000000003</MsgId>
                <CorrMsgId>00000000000000000000</CorrMsgId>
                <WorkDate>20260513</WorkDate>
              </HEAD>
              <MSG>
