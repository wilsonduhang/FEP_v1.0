 ...
 * fep-web 端用 {@code InboundRegistryArchTest}（T4）作权威 ArchUnit 强护栏覆盖全 24 entries
 * （含 batch 包内 2101/2102/2103/2104 + common 包内 9007/9009 P4-MSG-L 节点登录/登出回执
 * + common 包内 9020 P4-MSG-M 实时业务通用应答，后三者无业务 SerialNo 字段
 * implements SerialNoBearing 返回 null）。</p>
 */
class SerialNoBearingComplianceTest {

    /**
     * 17 个 supplychain 包内 inbound dispatcher 注册顶层 Body class
    ...
    /** 17 类 setter+getter roundtrip 工厂；显式 cast 保留类型安全无反射。 */
