...
/**
 * 3001 业务进展实时查询请求报文业务体。
 *
 * <p>字段顺序严格对应 {@code 3001.xsd} 中 {@code ProgressQuery3001} complexType 的 sequence：
 * SerialNo, SendNodeCode, DesNodeCode, hxqyName, hxqyCode, QueryType, QueryKey, ExtInfo?。</p>
 *
...
@XmlRootElement(name = "ProgressQuery3001")
@XmlType(propOrder = {
