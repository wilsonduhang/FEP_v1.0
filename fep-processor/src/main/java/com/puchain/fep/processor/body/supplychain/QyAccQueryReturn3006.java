...
/**
 * 3006 对公客户状态查询回执报文业务体。
 *
 * <p>字段顺序严格对应 {@code 3006.xsd} 中 {@code qyAccQueryReturn3006} complexType 的 sequence：
 * SerialNo, SendNodeCode, DesNodeCode, qyAccName, qyAccCode, AccReturnCode,
 * AccReturnMemo?, ExtInfo?。</p>
 *
...
@XmlRootElement(name = "qyAccQueryReturn3006")
@XmlType(propOrder = {
        "serialNo", "sendNodeCode", "desNodeCode",
        "qyAccName", "qyAccCode", "accReturnCode",
        "accReturnMemo", "extInfo"
})
public class QyAccQueryReturn3006 extends CfxBody implements SerialNoBearing {
    ...
    @XmlElement(name = "AccReturnCode", required = true)
    private String accReturnCode;

    @XmlElement(name = "AccReturnMemo")
    private String accReturnMemo;
    ...
    /**
     * Returns the account return code (账户查询结果编码).
     *
     * @return account return code
     */
    public String getAccReturnCode() {
        return accReturnCode;
    }

    /**
     * Sets the account return code.
     *
     * @param v account return code
     */
    public void setAccReturnCode(final String v) {
        this.accReturnCode = v;
    }

    /**
     * Returns the optional account return memo (账户查询结果说明).
     *
     * @return account return memo, or {@code null} if absent
     */
    public String getAccReturnMemo() {
        return accReturnMemo;
    }

    /**
     * Sets the account return memo.
     *
     * @param v account return memo
     */
    public void setAccReturnMemo(final String v) {
        this.accReturnMemo = v;
    }
