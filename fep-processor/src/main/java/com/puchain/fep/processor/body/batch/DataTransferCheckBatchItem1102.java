...
/**
 * 1102 报文中 {@code DataTransferCheck} 单核对项。
 *
 * <p>字段顺序严格对应 {@code 1102.xsd} 中 {@code DataTransferCheck} complexType 的 sequence：
...
@XmlType(name = "DataTransferCheck", propOrder = {
        "itemId", "mainClass", "secondClass", "period",
        "fileName", "fileDate", "status"
})
public class DataTransferCheckBatchItem1102 extends CfxBody {
