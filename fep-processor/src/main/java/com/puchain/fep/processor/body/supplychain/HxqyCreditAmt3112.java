 ...
 *
 * <p><b>SerialNoBearing</b>：实现该接口使本类可注册进 inbound dispatcher
 * BODY_TYPE_REGISTRY（银行被动接收 3112，PRD §4.6 line 841 模式5）；
 * dispatcher 据 {@code getSerialNo()} 派发 InboundMessageProcessedEvent.serialNo。</p>
 *
 * @author FEP Team
 * @since 1.0.0
 */
...
public class HxqyCreditAmt3112 extends CfxBody implements SerialNoBearing {
