...
/**
 * 3112 核心企业授信查询请求 FieldMapper —— Plan T7b 阶段为 stub。
 *
 ...
 */
@Component
public class HxqyCreditAmt3112FieldMapper implements FieldMapper {
    ...
    public Object toMessageBody(final Map<String, Object> rawData) {
        throw new UnsupportedOperationException(
                "mapper not implemented, see Plan §T7b Deferred D8 (3112)");
    }
}
