...
/**
 * 3105 电子凭证融资申请 FieldMapper —— Plan T7b 阶段为 stub。
 *
 ...
 */
@Component
public class RzApplyInfo3105FieldMapper implements FieldMapper {
    ...
    public Object toMessageBody(final Map<String, Object> rawData) {
        throw new UnsupportedOperationException(
                "mapper not implemented, see Plan §T7b Deferred D8 (3105)");
    }
}
